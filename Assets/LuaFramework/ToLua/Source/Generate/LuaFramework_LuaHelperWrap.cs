...
public class LuaFramework_LuaHelperWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("GetAsyncOperationMgr", GetAsyncOperationMgr);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetAsyncOperationMgr(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 0);
			LuaFramework.AsyncOperationMgr o = LuaFramework.LuaHelper.GetAsyncOperationMgr();
			ToLua.Push(L, o);
			return 1;
		}
		catch(Exception e)
