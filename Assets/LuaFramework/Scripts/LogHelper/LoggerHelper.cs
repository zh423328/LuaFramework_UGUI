...
namespace LuaFramework
{
    ...
    public class LoggerHelper
    {
        ...
        public static LogLevel mWriteLevels = LogLevel.ERROR | LogLevel.CRITICAL | LogLevel.EXCEPT;
        ...
        public static void Debug(object message)
        {
            ...
            if(LogLevel.DEBUG == (CurrentLogLevels & LogLevel.DEBUG))
                Log(string.Concat(" [DEBUG]: ", "", message, " Index = ", index++), LogLevel.DEBUG);
        }
        ...
        public static void Debug(string filter, object message)
        {
            if(DebugFilterStr != "" && DebugFilterStr != filter) return;

            if(LogLevel.DEBUG == (CurrentLogLevels & LogLevel.DEBUG))
            {
                Log(string.Concat(" [DEBUG]: ", "", message), LogLevel.DEBUG);
            }
        }
        ...
        public static void Info(object message)
        {
            if(LogLevel.INFO == (CurrentLogLevels & LogLevel.INFO))
                Log(string.Concat(" [INFO]: ", "", message), LogLevel.INFO);
        }
        ...
        public static void Warning(object message)
        {
            if(LogLevel.WARNING == (CurrentLogLevels & LogLevel.WARNING))
                Log(string.Concat(" [WARNING]: ",  "", message), LogLevel.WARNING);
        }
